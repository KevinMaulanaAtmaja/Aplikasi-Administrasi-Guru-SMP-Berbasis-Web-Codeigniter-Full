    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning bg-warning" style="color: #000; font-size: small;">
                <b>Petunjuk : </b><br>
                <ul>
                    <li>Menu ini digunakan untuk menginput nilai penilaian tengah semester pada mata pelajaran <b><i><?php echo $detil_mp['namamapel'] . ", kelas ". $detil_mp['namakelas']; ?>.</i></b> </li>
                    <li>Dari <b><i>skala 1-100</i></b> untuk mengisikan nilai pts. Jangan lupa klik tombol <b><i>Simpan</i></b> di sebelah bawah.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="m-0 text-gray-900">Nilai PTS &raquo; <?php echo $detil_mp['namamapel'] . " - "  . $detil_mp['namakelas']; ?></h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-7">
            <div class="card shadow">
                <div class="card-header">
                    <h5 class="m-0 text-gray-900">Input Nilai PTS</h5>
                </div>
                <div class="card-body">
                    <form method="post" action="<?= base_url('guru/simpan_nilai'); ?>">
                        ...
                        <input type="hidden" name="djenis" id="djenis" value="t">
